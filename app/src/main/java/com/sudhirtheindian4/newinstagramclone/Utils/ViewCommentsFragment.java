...
//
//public class ViewCommentsFragment {
//}
        ...
        mCheckMark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!mComment.getText().toString().equals("")) {
                    ...
                    mComment.setText("");
                    closeKeyboard();
                    Toast.makeText(mContext, "you have send message", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(getActivity(), "you can not post a blank comment", Toast.LENGTH_SHORT).show();
...
//                .child(FirebaseAuth.getInstance().getCurrentUser().getUid())
    ...
    private String getTimestamp() {
        ...
        sdf.setTimeZone(TimeZone.getTimeZone("Asia/Calcutta"));  /// android list of google timezone
