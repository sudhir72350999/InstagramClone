...
public class ShareActivity extends AppCompatActivity {
    ...
    private void setupViewPager(){
        ...
        adapter.addFragmment(new GalleryFragment());
        adapter.addFragmment(new PhotoFragment());
    ...
    private void setupBottomNavigationView(){
        ...
        BottomNavigationView bottomNavigationView = (BottomNavigationViewEx) findViewById(R.id.bottomNavViewBar);
